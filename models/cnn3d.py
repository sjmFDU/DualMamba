...
def cnn3d(dataset, patch_size):
    ...
    if dataset == 'sa':
        ...
        model = CNN3D(input_channels=48, n_classes=20, patch_size=patch_size)
    elif dataset == 'whu-ohs':
        model = CNN3D(input_channels=32, n_classes=24, patch_size=patch_size)
    return model


if __name__ == '__main__':

    net = cnn3d(dataset='hu2018', patch_size=13)
